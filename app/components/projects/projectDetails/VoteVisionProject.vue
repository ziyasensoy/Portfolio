<template>
  <div class="project-content">
    ...
    <h2>{{ t("Projects.items.votevision.content.contributionsTitle") }}</h2>

    <p>{{ t("Projects.items.votevision.content.contribution1") }}</p>
    <p>{{ t("Projects.items.votevision.content.contribution2") }}</p>
